...
export default function Footer() {
  return (
    <footer className="w-full glass-panel border-t border-slate-900 bg-slate-950/80 py-8 px-4 sm:px-8 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center space-x-4 text-slate-400">
          <a href="#" className="hover:text-yellow-400 transition-colors"><Globe className="w-4 h-4" /></a>
          <a href="#" className="hover:text-yellow-400 transition-colors"><Compass className="w-4 h-4" /></a>
        </div>
